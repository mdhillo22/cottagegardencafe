...
router.post('/', function(req, res, next) {
    let insertquery = "INSERT INTO category (category_id, categoryname, description) VALUES (?, ?, ?)";
    db.query(insertquery,[req.body.category_id, req.body.categoryname, req.body.description],(err, result) => {
    if (err) {
        console.log(err);
        res.render('error');
    } else {
...
router.post('/save', function(req, res, next) {
    let updatequery = "UPDATE category SET category_id = ?, categoryname = ?, description = ? WHERE category_id = " + req.body.category_id;
    db.query(updatequery,[req.body.category_id, req.body.categoryname, req.body.description],(err, result) => {
    if (err) {
        console.log(err);
        res.render('error');
    } else {
